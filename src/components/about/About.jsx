...
function About() {
    ...
    return (
        <div className="container about my-3 py-3 px-4">
            ...
            <p className="col">
                I've been studying Programming since 2016, after finishing College I found an interest in web development, so here we are, currently looking for new experiences.
            </p>
            <p className="col">
